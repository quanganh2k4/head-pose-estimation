...
- [C++/DeepStream design](docs/architecture.md)
- [Benchmark](docs/benchmarks.md)
- Technical deep-dive interview notes are kept locally and are not public.

## License

Dự án được phát hành theo [MIT License](LICENSE). Giấy phép này **không** áp dụng cho một số thành phần bên thứ ba (sample code proprietary của NVIDIA DeepStream SDK, model PeopleNet) — xem chi tiết và cách tự lấy về tại [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md).
